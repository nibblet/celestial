...
## Appearances
- Thane stationary study; glyphs shift toward neural metaphors (CH06).

## Additional appearances
- Pulse coordination hypothesis across sites (CH11).
...
**Content type:** vault
**Subkind:** site
**Canon name:** Vault of First Light
**Discovery Order:** 2
**Activation Order:** 1
**Status:** cataloged
...
**Source path:** celestial_original/Vault Encounter Tracker v2.md
**Extractor version:** seed-canon-entities/1
**Chapter refs:** CH06, CH11

## Note
Canonical slug `vault-002` consolidates the earlier hand-authored `martian-resonance-vault` seed and the canon-inventory dossier under a single entity. Physical chambers such as `subsurface-vault` sit beneath Valkyrie-1 on the same Mars site.
